    ...
    <AndroidFrame onBackPress={handleAndroidBack} onHomePress={handleAndroidHome}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        {currentScreen === "profile" && (
          <div className="flex-1 overflow-y-auto bg-white p-5 space-y-5 select-none pb-12">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-4 space-y-3">
              ...
              <div className="flex items-center justify-between py-2 border-b border-gray-200">
                ...
                <span className="text-sm font-semibold text-gray-900">Workspace Owner</span>
              </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-gray-100 border border-gray-200 text-gray-800 font-medium text-xs hover:bg-gray-200"
            >
