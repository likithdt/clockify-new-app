      ...
      <div className="p-3.5 space-y-3 shrink-0">
        ...
        <div className="flex items-center justify-between bg-[#181e25] border border-[#262e37] rounded-2xl p-1.5 text-xs text-[#c2cbd4]">
          ...
          <div className="flex items-center gap-1">
            <button
              type="button"
              className="p-1 rounded-lg hover:bg-white/5 text-[#8c9ba5] hover:text-white transition"
              ...
              <div className="flex-1 overflow-x-auto relative">
                ...
                >
                  ...
                  <div className="sticky top-0 z-20 bg-[#14181f] border-b border-[#262e37]">
                    {/* Days row */}
                    <div className="h-12 flex text-[11px] font-medium text-[#8c9ba5]">
                      {days.map((day) => (
                        <div
                          key={day.dateStr}
                        ...
                        >
                          ...
                          {day.isCurrentDay && (
                            <span className="absolute top-1 w-1.5 h-1.5 rounded-full bg-[#00b0ff]" />
                          )}
                        </div>
                      ))}
                    </div>
