...
export const NavigationDrawer: React.FC<NavigationDrawerProps> = ({
  ...
  return (
    <div className="absolute inset-0 z-50 flex">
      {/* Dimmed backdrop */}
      <div
        className="absolute inset-0 bg-black/60 backdrop-blur-[1px] transition-opacity animate-fadeIn"
        onClick={onClose}
      />
      ...
      <div className="relative w-[82%] max-w-[340px] h-full bg-[#1b2026] text-white flex flex-col z-10 shadow-2xl overflow-y-auto animate-slideInLeft border-r border-[#262e37]">
        ...
        <div className="flex-1 px-3 py-2 space-y-1">
          ...
          >
            <LayoutDashboard className="w-5 h-5 text-[#8c9ba5]" />
            <span>Dashboard</span>
          </button>
          ...
          >
            <Scale className="w-5 h-5 text-[#8c9ba5]" />
            <span>Rates</span>
          </button>
