...
export function RemoveSampleScheduleModal() {
            ...
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg overflow-hidden border border-[#E2E8F0] animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="p-6 space-y-4 text-xs text-[#334155] leading-relaxed">
                    <ul className="space-y-2 list-disc list-inside">
                        <li>
                            All automatically added sample schedules, projects, and assignments will be removed
                            from the workspace.
                        </li>
                        <li>
                            All schedules manually created by you or your users will be preserved.
                        </li>
                    </ul>

                    <p className="pt-2 text-[#64748B]">
                        You can always re-populate sample data by clicking Restore Sample Data in the Schedule view.
                    </p>
