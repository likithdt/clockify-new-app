    ...
    <>
      ...
      <div className="absolute bottom-6 right-5 z-40 flex flex-col items-end select-none">
        ...
        {isOpen ? (
          ...
          /* Default '+' button when speed dial is closed matching Screenshot 3 */
          <div
            onClick={onToggle}
            className="w-14 h-14 cursor-pointer active:scale-95 transition-transform"
          >
            <button
              type="button"
              className="w-full h-full bg-[#00b0ff] hover:bg-[#009be0] rounded-2xl flex items-center justify-center shadow-lg text-white transition-colors"
