...
export default function App() {
  // Check URL hash for direct routing (#invoices, #approvals, #dashboard, etc.)
  const getInitialPage = (): ActivePage => {
    const hash = window.location.hash.toLowerCase();
    if (hash.includes("invoice")) return "invoices";
    ...
    return "invoices"; // Default to newly developed Invoices
  };
  ...
  return (
    <div className="h-screen w-screen overflow-hidden font-sans select-none relative">
      ...
      {activePage === "invoices" ? (
        <InvoicesPage onNavigateScreen={handleNavigation} />
      ) : activePage === "approvals" ? (
